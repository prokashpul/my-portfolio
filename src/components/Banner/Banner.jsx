...
const Banner = () => {
  ...
  return (
    <div className=" mb-10 md:mb-20 relative" id="home">
      <Particles
        id="tsparticles"
        init={particlesInit}
        ...
        <div className=" flex flex-col justify-center">
          <div>
            ...
            <p>
              ...
              accumulated knowledge on various aspects of web development. My
              goal is to be an outstanding full-stack web developer who can
              create beautiful UIs and manage back-end smoothly.
            </p>
